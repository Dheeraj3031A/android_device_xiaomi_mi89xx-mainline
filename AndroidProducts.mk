...
PRODUCT_MAKEFILES := \
    ...
    aosp_mi8956:$(LOCAL_DIR)/mi8953_a/aosp_mi8956.mk \
    ...
    aosp_tissot_mainline:$(LOCAL_DIR)/tissot_mainline/aosp_tissot_mainline.mk \
    ...
    lineage_tissot_mainline:$(LOCAL_DIR)/tissot_mainline/lineage_tissot_mainline.mk
...
$(foreach build_type, user userdebug eng, \
    ...
    $(eval COMMON_LUNCH_CHOICES += aosp_mi8956-$(build_type)) \
    ...
    $(eval COMMON_LUNCH_CHOICES += aosp_tissot_mainline-$(build_type)) \
    ...
    $(eval COMMON_LUNCH_CHOICES += lineage_tissot_mainline-$(build_type)))
