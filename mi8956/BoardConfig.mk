...
TARGET_DTB_LIST_WILDCARD := qcom/msm8956-xiaomi-*

TARGET_KERNEL_CONFIG := msm8956_defconfig
...
# OTA
TARGET_OTA_ASSERT_DEVICE := mi8956
...
TARGET_RECOVERY_FSTAB := $(TARGET_DEVICE_PATH)/fstab/fstab.mi8956
